...
export default function Projects() {
  return (
    ...
    <h1 className='text-4xl font-light text-white md:text-6xl flex justify-center mb-10'>Projects</h1>
      ...
      <Card title={"E-Cart"} image={"/e-cart.png"} about={"A full-stack web app built with React, Tailwind CSS, Express, Mongoose, and JWT etc. The e-cart is the place where user can buy a product with there adresses and also update there all details  "} links={"https://e-cart-t963.onrender.com"} react={"react"} mongoDB={"MongoDB"} express={"Express"} tailwind={"tailwind"} jwt={"JWT"}/>
        ...
        <Card title={"100xDevs"} image={"/100xdevs.png"} about={"100xDevs pltform that sell course"} react={"react"} mongoDB={"mongoDB"} express={"Express"} tailwind={"tailwind"} links={"https://one00xdevs-1fe.onrender.com/"}/>
        <Card title={"Payment App"} image={"/payment.png"} about={"A platform where any one can send or receive money from friends "} react={"react"} mongoDB={"mongoDB"} express={"Express"} tailwind={"tailwind"} links={"https://payment-app-onxi.onrender.com"}/>

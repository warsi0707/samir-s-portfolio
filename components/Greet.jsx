...
export default function Greet() {
  return (
    <div className='flex px-16 md:px-32 pt-40 w-full items-center justify-center py-28 mx-auto h-[100vh]'>
        ...
        className='flex flex-col  sm:px-16  sm:flex-row md:flex-col space-y-5 '>
           ...
           <motion.div 
            ...
            animate={{y:0, opacity:1}}
            transition={{duration: 0.8,delay:0.2}}
           className='flex max-w-[600px] flex-col mx-auto justify-center text-center gap-5'>
           ...
           <p className='md:text-base text-pretty text-sm text-gray-400'>Software developer with passion for building impactful web solution. Always learning, always creating</p>
            <div className="flex flex-col lg:flex-row items-center gap-3 justify-between">
              ...
              <Link href={"https://drive.google.com/file/d/19fbR2RlQCN4mxLTQd6VzLyQE6drw-8Ks/view?usp=sharing"} className="flex items-center bg-slate-300 text-black p-3 text-xl rounded-full ">
                <p>Download CV</p>
                <p><IoIosArrowRoundForward/></p>
              </Link>
